{ fetchurl, fetchgit, linkFarm, runCommand, gnutar }: rec {
  ...
  packages = [
    ...
    {
      name = "http2_express___http2_express_1.0.1.tgz";
      path = fetchurl {
        name = "http2_express___http2_express_1.0.1.tgz";
        url  = "https://registry.yarnpkg.com/http2-express/-/http2-express-1.0.1.tgz";
        sha512 = "3NP5595eHFkZOBD4RXCNDrTQvuxKfcr3Q62RrHlywNc0vw/PR2HKxtF4JqFhXWVJsxb9pTf/1hZ8iLaJrWdUmQ==";
      };
    }
    {
    ...
    {
      name = "node_media_server___node_media_server_4.0.7.tgz";
      path = fetchurl {
        name = "node_media_server___node_media_server_4.0.7.tgz";
        url  = "https://registry.yarnpkg.com/node-media-server/-/node-media-server-4.0.7.tgz";
        sha512 = "Hht48iZ1T8k+Aq8H5i8zRlACbcjr2NavMq8ajng9u1tWp4tlD9ACpM1lLzy5+j3/wPu2C5RpI2Z4ZBOPq5/jLQ==";
      };
    }
    {
