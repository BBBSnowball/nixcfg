  ...
  services.mediawiki = {
    ...
    extensions = {
      ...
      LDAPAuthentication2 = pkgs.fetchzip {
        ...
        url = "https://extdist.wmflabs.org/dist/extensions/LDAPAuthentication2-REL1_43-0795e38.tar.gz";
        hash = "sha256-q9mycwtoPhVwduryuGNlOAl5G6qkdvmFNQnfEmruun8=";
      };
      LDAPProvider = pkgs.fetchzip {
        ...
        url = "https://extdist.wmflabs.org/dist/extensions/LDAPProvider-REL1_43-35ead31.tar.gz";
        hash = "sha256-qXmfU3MrlztdxZZ7idwL+nzByIcXhVFg5SWfTVpvKIA=";
      };
      LDAPAuthorization = pkgs.fetchzip {
        ...
        url = "https://extdist.wmflabs.org/dist/extensions/LDAPAuthorization-REL1_43-9c0788f.tar.gz";
        hash = "sha256-8ZSpEPMuqHDfzUQwpS0sNj9Mmmp3ZnN97u5ww4KzU4U=";
      };
      LDAPUserInfo = pkgs.fetchzip {
        ...
        url = "https://extdist.wmflabs.org/dist/extensions/LDAPUserInfo-REL1_43-7913cd2.tar.gz";
        hash = "sha256-6OW99o94baqRplm/K2zoIOUWUevpFkE+2Ss1cSVvzRE=";
      };
      PluggableAuth = pkgs.fetchzip {
        ...
        url = "https://extdist.wmflabs.org/dist/extensions/PluggableAuth-REL1_44-85e96ac.tar.gz";
        hash = "sha256-Hjol18Aqm6cR6Aj7PXN13JOFLoQAa8WiJVDU1R73jsU=";
      };
      LDAPSyncAll = pkgs.fetchzip {
        ...
        url = "https://extdist.wmflabs.org/dist/extensions/LDAPSyncAll-REL1_43-e273b29.tar.gz";
        hash = "sha256-JgRo93sNt69B6cB0wuqSq/oMlu5jFMNiXqN0uCLC/A8=";
      };
      LDAPGroups = pkgs.fetchzip {
        ...
        url = "https://extdist.wmflabs.org/dist/extensions/LDAPGroups-REL1_43-f3fa6ef.tar.gz";
        hash = "sha256-9WMmCe/X26/UsvyPpg/8+ofKIVWOwsiIYPfrKI/tKOI=";
      };
    };
  };
