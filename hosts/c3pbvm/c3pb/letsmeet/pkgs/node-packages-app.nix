...
{nodeEnv, fetchurl, fetchgit, edumeetSrc, nix-gitignore, stdenv, lib, globalBuildInputs ? []}:
...
let
  sources = {
    ...
    "bowser-2.10.0" = {
      ...
      version = "2.10.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/bowser/-/bowser-2.10.0.tgz";
        sha512 = "OCsqTQboTEWWsUjcp5jLSw2ZHsBiv2C105iFs61bOT0Hnwi9p7/uuXdd7mu8RYcarREfdjNN+8LitmEHATsLYg==";
      };
    };
    ...
    "flip-toolkit-7.0.11" = {
      ...
      version = "7.0.11";
      src = fetchurl {
        url = "https://registry.npmjs.org/flip-toolkit/-/flip-toolkit-7.0.11.tgz";
        sha512 = "T3iMFg9Rk2WdR+G4mbIljQWs+oRYTQZjox35Wr1JRIVDGFy48Ad7CYv/FKJb6RTVtAB4bSFLi2vDpxSgKWdPYQ==";
      };
    };
    ...
    "http-node-git+https://github.com/webtorrent/http-node#d3a9d882d28c71ffe65c251361909de4a569fc50" = {
      name = "_at_webtorrent_slash_http-node";
      packageName = "@webtorrent/http-node";
      version = "1.3.0";
      src = fetchgit {
        url = "https://github.com/webtorrent/http-node";
        rev = "d3a9d882d28c71ffe65c251361909de4a569fc50";
        sha256 = "bf761bda15404f8da4e0f2b56dffa4e4c2a1aa7a5a5974cd453c7943d496eb22";
      };
    };
    ...
    "mediasoup-client-3.6.13" = {
      name = "mediasoup-client";
      packageName = "mediasoup-client";
      version = "3.6.13";
      src = fetchurl {
        url = "https://registry.npmjs.org/mediasoup-client/-/mediasoup-client-3.6.13.tgz";
        sha512 = "E5pMTmMLN+Qv6+Zh+CHvMh3KCLqSw2rclWsjN+GYWRSk+qnlunXCaVd2XKh0bTw9V7tVwnD1uTssOs6JfqpC3g==";
      };
    };
    "mediasource-2.3.0" = {
      name = "mediasource";
    ...
    "react-flip-toolkit-7.0.12" = {
      ...
      version = "7.0.12";
      src = fetchurl {
        url = "https://registry.npmjs.org/react-flip-toolkit/-/react-flip-toolkit-7.0.12.tgz";
        sha512 = "JMACwG+oGSDEvQxXZIlZ64EOIZJhw5XZ+1MLHsxDoNWP+Jzb9ZNfKP13jM2rW/sOuN/rLiVPOayHIFWcksu/BA==";
      };
    };
    "react-intl-3.12.1" = {
      name = "react-intl";
    ...
    "react-scripts-3.4.3" = {
      ...
      version = "3.4.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/react-scripts/-/react-scripts-3.4.3.tgz";
        sha512 = "oSnoWmii/iKdeQiwaO6map1lUaZLmG0xIUyb/HwCVFLT7gNbj8JZ9RmpvMCZ4fB98ZUMRfNmp/ft8uy/xD1RLA==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."http-node-git+https://github.com/webtorrent/http-node#d3a9d882d28c71ffe65c251361909de4a569fc50" // {
        dependencies = [
      ...
      sources."mediasoup-client-3.6.13"
      ...
      sources."react-flip-toolkit-7.0.12"
