...
let
  ...
  sources = {
    ...
    "@types/got-9.6.10" = {
      ...
      version = "9.6.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/got/-/got-9.6.10.tgz";
        sha512 = "owBY1cgHUIXjObzY+vs+J9Cpw0czvfksJX+qEkgxRojFutFq7n1tKoj6Ekg57DhvXMk0vGQ7FbinvS9I/1wxcg==";
      };
    };
    "@types/node-13.13.1" = {
    ...
    "jose-1.26.0" = {
      ...
      version = "1.26.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/jose/-/jose-1.26.0.tgz";
        sha512 = "mXZAgJIX/mDKjbnX/arEVpJaFs3g5cfZMpcsGlhLQ6X+CCL0YV46FVNa3wHKVe3iZD1qVtAdj3fLhbXqI+6/dQ==";
      };
    };
    "jsbn-0.1.1" = {
      name = "jsbn";
    ...
    "openid-client-3.14.2" = {
      ...
      version = "3.14.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/openid-client/-/openid-client-3.14.2.tgz";
        sha512 = "ga9YL3H7lNYEO1T0zRqovVqzwlljI9CgpBCYESrb/xhRbj/LOIQRAoipCvvjZj2JGgvSR1H6PFwgzcx1Cd1z8A==";
      };
    };
    "p-any-3.0.0" = {
      name = "p-any";
