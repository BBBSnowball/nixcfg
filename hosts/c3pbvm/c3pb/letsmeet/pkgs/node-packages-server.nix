...
{nodeEnv, fetchurl, fetchgit, runCommand, edumeetSrc, globalBuildInputs ? []}:
...
let
  ...
  sources = {
    ...
    "jose-1.28.0" = {
      ...
      version = "1.28.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/jose/-/jose-1.28.0.tgz";
        sha512 = "JmfDRzt/HSj8ipd9TsDtEHoLUnLYavG+7e8F6s1mx2jfVSfXOTaFQsJUydbjJpTnTDHP1+yKL9Ke7ktS/a0Eiw==";
      };
    };
    "jsbn-0.1.1" = {
      name = "jsbn";
    ...
    "xml-crypto-2.0.0" = {
      ...
      version = "2.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/xml-crypto/-/xml-crypto-2.0.0.tgz";
        sha512 = "/a04qr7RpONRZHOxROZ6iIHItdsQQjN3sj8lJkYDDss8tAkEaAs0VrFjb3tlhmS5snQru5lTs9/5ISSMdPDHlg==";
      };
    };
